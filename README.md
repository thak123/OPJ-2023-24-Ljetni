...
10. Modelling/Training [Choose any min-3 max-5. Following list will be updated with more options and notebooks]
    ...
    - GenAI - Generative-AI (https://unsloth.ai/docs/get-started/unsloth-notebooks)[https://unsloth.ai/docs/get-started/unsloth-notebooks], [LLAMA Model](code/llam_train_7b.py)
